          ...
          <div className="grid grid-cols-2 gap-3 md:gap-4 mb-6">
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 bg-gray-800 text-white border-r-8 border-transparent outline outline-1 outline-slate-600 focus:border-slate-400 focus:outline-none text-sm"
              >
                {STATUSES.map(status => (
